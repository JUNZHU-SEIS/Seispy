<img alt="Seispy: A Python Toolbox for seismological applications." class="right" style="width: 60%" src="https://raw.githubusercontent.com/JUNZHU-SEIS/code/main/ustcblue.jpg"/>
...
Seispy is an open-source project dedicated to provide a **Python framework for processing seismological** data. It provides parsers for common file formats, clients to access data centers and seismological signal processing routines which allow the manipulation of seismological time series
...
The goal of the Seispy project is to facilitate **rapid application development for seismology**.

Seispy is licensed under the GNU Lesser General Public License (LGPL) v3.0.
